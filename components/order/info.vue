    ...
    <div class="p-4 py-6">
      <div class="flex flex-col gap-4">
        <dl class="flex items-center">
          <dt class="w-[180px]">주문번호</dt>
          <dd class="flex items-center gap-3 flex-1">
           <span>571E53-2474</span>
          </dd>
        </dl>
        <dl class="flex items-center">
          <dt class="w-[180px]">주문일시</dt>
          <dd class="flex items-center gap-3 flex-1">
           <span>2024년 08월 28일 13시 55분</span>
          </dd>
        </dl>
        
        <dl class="flex items-center">
          <dt class="w-[180px]">세탁소</dt>
          <dd class="flex items-center gap-3 flex-1">
            <span>워시앤클린 광안점</span>
          </dd>
        </dl>
      ...
      <div class="flex flex-col gap-4">
        <dl class="flex items-center">
          <dt class="min-w-[180px]">배송 요청사항</dt>
          <dd class="flex flex-col flex-1 gap-3">
            <textarea class="resize-none border rounded-md border-gray-300 p-3 min-h-[100px]">빠른 배송 부탁드려요</textarea>
          </dd>
        </dl>
        <dl class="flex items-center">
          <dt class="min-w-[180px]">세탁 요청사항</dt>
          <dd class="flex flex-col flex-1 gap-3">
            <textarea class="resize-none border rounded-md border-gray-300 p-3 min-h-[100px]">꺠끗하게 부탁드려요</textarea>
          </dd>
        </dl>
        <dl class="flex items-center">
          <dt class="flex flex-col gap-1 min-w-[180px]">
            <span>첨부사진</span>
          ...
          <dd class="flex items-center gap-3">
            <div v-for="item in 3" class="w-[100px] h-[100px] overflow-hidden rounded-md cursor-pointer">
              <img src="https://picsum.photos/200/300" class="w-full h-full object-cover object-center ">
            </div>
          </dd>
        </dl>
      </div>  
